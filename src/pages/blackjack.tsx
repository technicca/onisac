    ...
    <div className="w-96 max-w-sm h-screen flex items-center flex-col">
      ...
      <div id="dealerHand" className="flex justify-center mt-14 relative scale-[0.8] flex-wrap w-[300px]">
        ...
        {dealerDeck.map((card, index) => {
          if (canPlay) {
            const hidden = index == 0 ? "bg-[url('/bjack/cards/cardBack.png')] -rotate-6 -mt-3" : "bg-[url('/bjack/cards/card.png')]";
            ...
            return <div key={index} className={`flex justify-center items-center text-4xl text-[#6D5C5C] bg-[url('/bjack/cards/card.png')] bg-cover w-24 h-36 -ml-6 ${animateNewCard} ${sendToAbove}`}>{card.figure}</div>
          }
        })}
      </div>


      <div className="bg-[url('/bjack/cards/dealerShadow.png')] bg-inherit bg-no-repeat w-40 h-4 mt-10"></div>
      ...
      <div id="playerHand" className="flex justify-center mt-14 relative scale-[0.7] flex-wrap w-[350px]">
        ...
        {yourDeck.map((card, index) => {
          ...
          return <div key={index} className={`flex justify-center items-center text-6xl text-[#6D5C5C] bg-[url('/bjack/cards/card.png')] bg-cover w-32 h-48 -ml-6 animate-getCard -rotate-2 ${sendToAbove}`}>{card.figure}</div>
        })}
      ...
      <div className="bg-[url('/bjack/cards/yourShadow.png')] bg-inherit bg-no-repeat w-60 h-10 mt-10 relative scale-[0.8] md:scale-100 -z-50"></div>
